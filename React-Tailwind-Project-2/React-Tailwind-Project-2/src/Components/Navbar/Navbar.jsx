...
function Navbar() {
  ...
  return (
    <div className="w-full bg-transparent backdrop-blur-lg h-16 flex justify-between items-center px-10 sm:px-20 border-b-[2px] fixed top-0">
      <div>
        <svg
          width="140"
          height="28"
      ...
      <div className="hidden lg:block">
        <ul className="sm:flex gap-10 text-md font-normal text-gray-400">
      ...
      <div className="flex gap-4 justify-center items-center">
        ...
        {/* show dropdown */}
        <div
          className={`${show ? "block" : "hidden"} lg:hidden text-2xl relative`}
        >
          <ul className="flex flex-col gap-4 text-sm absolute right-4 top-8 rounded-lg font-normal bg-white shadow-xl w-52 px-5 py-2 text-gray-400">
            <li className="cursor-pointer hover:text-[#8b5cf6] duration-200">
              Featurs
            </li>
            <li className="cursor-pointer hover:text-[#8b5cf6] duration-200">
