import input from "../../assets/images/Screenshot 2024-11-06 123100.png";
      ...
      <div className=" mt-20 w-full bg-custom-bg h-auto flex md:flex-row justify-between gap-4 items-start sm: flex-wrap py-28 px-10 sm:px-20 flex-col">
        ...
        <div className="max-w-[300px] flex flex-col sm:flex-col gap-5">
          ...
          <div className="text-gray-400">
            ...
            distinctio aliquam sapiente consectetur.
          </div>
          <div className="flex gap-5">
            <FaFacebook className="text-gray-400 hover:text-gray-700 cursor-pointer duration-200" />
            <FaTwitter className="text-gray-400 hover:text-gray-700 cursor-pointer duration-200" />
            <FaInstagram className="text-gray-400 hover:text-gray-700 cursor-pointer duration-200" />
            <FaLinkedin className="text-gray-400 hover:text-gray-700 cursor-pointer duration-200" />
          </div>
        </div>
        ...
        <div className="max-w-[300px] flex flex-col sm:flex-col gap-5">
          ...
          <div className="text-gray-400">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad,
            distinctio aliquam sapiente
          </div>
          <div className="flex gap-5 w-52 h-10 rounded-lg overflow-hidden">
            <img src={input} alt="" />
          </div>
        </div>
      </div>
      <h1 className="font-semibold text-center py-7 text-md text-gray-400">
